...
$pdf->Cell(40, 8,'', 1, 1, 'L'); 
$pdf->SetXY(45.5, 36.6);
$pdf->Cell(28, 8, 1, 1, 'C'); //Hora SI
$pdf->SetXY(5.5, 44.6);
$pdf->Cell(68, 8, 1, 1, 'L'); //Reporte de seccion SI

$pdf->SetFont('Arial', 'B', 13);
$pdf->SetXY(73.5, 36.6);
$pdf->SetTextColor(255, 0, 0); 
$pdf->Cell(37.7, 16, 1, 1, 'C'); // Folio SI
$pdf->SetTextColor(0);

$pdf->SetFont('Arial','',8);
$pdf->SetXY(22.5, 36.6); 
$pdf->Cell(40, 8, 0, 1, 'L'); //Fecha SI
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5.5, 58.1);
$pdf->Cell(45, 8, 'BL', 1, 'L');//Nombre de la via SI
$pdf->SetXY(50.5, 58.1);
$pdf->Cell(27.9, 8, 'B', 1, 'L');//Kilometro o numero SI
$pdf->SetXY(78.5, 58.1);
$pdf->Cell(32.8, 8, 'BR', 1, 'C');//Direccion o sentido
$pdf->SetXY(5.5, 66.1);
$pdf->Cell(72.8, 8, 'BL', 1, 'L');//Referencia del lugar
$pdf->SetXY(78.5, 66.1);
$pdf->Cell(32.8, 8, 'BR', 1, 'L');//Municipio NO (Debe ser el municipio propio de la multa AGERGAR A MULTA y no de la direccion)
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5.5, 79.8);
$pdf->Cell(52.5, 8, 'BL', 1, 'L');//Nombre (s) (SI enlazar con la tabla conductores)
$pdf->SetXY(58.1, 79.8);
$pdf->Cell(19, 8, 'M', 'BR', 1, 'C');//Sexo (SI en la tabla conductores)
$pdf->SetXY(77.3, 79.8);
$pdf->Cell(34, 8, 'BR', 1, 'L');//Numero de licencia (SI TABLA LICENCIAS)
$pdf->SetXY(5.5, 88);
$pdf->Cell(71.5, 8, 'BLR',1, 'L');//Apellido Paterno (SI en la tabla conductores)
$pdf->SetXY(77.1, 90);
$pdf->Cell(34.2, 6, 'BR', 1, 'C');//Fecha de vencimiento ()
$pdf->SetXY(5.5, 96.2);
$pdf->Cell(71.5, 8, 'BLR', 1, 'L');//Apellido Materno (SI TABLA CONDUCTORES)
$pdf->SetXY(77.2, 96.2);
$pdf->Cell(34.1, 8, 'QRO', 'BR', 1, 'C');//Estado de procedencia (SI TABLA PROCEDENCIA)
$pdf->SetXY(5.5, 104.4);
$pdf->Cell(71.5, 8, 'BLR', 1, 'L');//Calle (SI TABLA DIRECCIONES)
$pdf->SetXY(45.8, 104.4);
$pdf->Cell(18.5, 8, '0', 1, 'L');//Numero (SI TABLA DIRECCIONES)
$pdf->SetXY(5.5, 112.6);
$pdf->Cell(71.5, 8, 'BLR', 1, 'L');//Municipio (SI TABLA DIRECCIONES)
$pdf->SetXY(40.8, 112.6);
$pdf->Cell(18.5, 8, '0', 1, 'L');//Localidad (SI TABLA DIRECCIONES)
$pdf->SetXY(94.3, 104.4);
$pdf->Cell(17, 16.2, 'BR', 1, 'C');//Tipo (SI TABLA TARJETAS = TIPOSERVICIO)
$pdf->SetFont('Arial','',7);
$pdf->SetXY(77.2, 104.4);
$pdf->Cell(17, 16.2, 'BR', 1, 'C');//Clasificacion (conductor) (SI TABLA LICENCIA)
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5.5, 126.5);
$pdf->Cell(36, 8, 'BL', 1, 'L');//Tipo (vehiculo) (SI TABLA VEHICULOS)
$pdf->SetXY(41.7, 126.5);
$pdf->Cell(34, 8, 'B', 1, 'L');//Marca (SI TABLA VEHICULOS)
$pdf->SetXY(75.9, 126.5);
$pdf->Cell(35.4, 8, 'BR', 1, 'L');//Linea (SI TABLA VEHICULOS)
$pdf->SetXY(5.5, 134.7);
$pdf->Cell(27, 8, 'BL', 1, 'L');//Año (SI TABLA VEHICULOS)
$pdf->SetXY(32.7, 134.7);
$pdf->Cell(23, 8, 'B', 1, 'L');//Color (SI TABLA VEHICULOS)
...
$pdf->Cell(25, 8, 'BR', 1, 'L');//Estado de procedencia (SI TABLA VEHICULOS)
$pdf->SetXY(88.1, 134.7);
$pdf->Cell(23.2, 16.2, 'BR', 1, 'C');//Servicio (SI TABLA TARJETAS)
...
$pdf->Cell(9.8, 4, 'B', 1, 'C');//Fundamento articulo SI
$pdf->SetXY(56.5, 156);
...
$pdf->SetFont('Arial', '', 9);
$pdf->SetXY(5.5, 164.7);
$pdf->MultiCell(105.8, 6, 0 , 'L');//Motivo
$pdf->SetAutoPageBreak(false);
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5.5, 225.8);
$pdf->Cell(62.5, 8, 'BL', 1, 'L');//Nombre Agente (SI TABLA AGENTES)
$pdf->SetXY(5.5, 234);
$pdf->Cell(62.5, 8, 'BL', 1, 'L');//Apellidos Agente (SI TABLA AGENTES)
$pdf->SetXY(5.5, 242.2);
$pdf->Cell(62.5, 8, 'BL', 1, 'L');//Grupo, Region o Asignacion (SI TABLA AGENTES)
$pdf->SetXY(68.2, 225.8);
$pdf->Cell(43.1, 8, 'BLR', 1, 'C');//ID Agente (SI TABLA AGENTES)
$pdf->SetXY(68.2, 234);
...
$pdf->SetAutoPageBreak(true);
$pdf->SetXY(5.5, 256.2);
$pdf->MultiCell(105.8, 6, 0 , 'L');//ObservacionesPersonal SI
$pdf->SetAutoPageBreak(false);
...
$pdf->SetAutoPageBreak(true);
$pdf->SetXY(5.5, 281.2);
$pdf->MultiCell(105.8, 6, 0 , 'L');//Calificacion de la Boleta SI
$pdf->SetXY(5.5, 281.2);
